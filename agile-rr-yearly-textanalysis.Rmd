...
keywords_2019 <- word_counts_sums_total_2018
...
round(rbind(
  dplyr::bind_cols("year" = 2018, keywords_2018[-(1)] / (full_papers_2018 + other_papers_2018)),
  dplyr::bind_cols("year" = 2019, keywords_2019[-(1)] / (full_papers_2019 + other_papers_2019))
), digits = 2)
```
...
round(rbind(
  dplyr::bind_cols("year" = 2018, keywords_2018[-(1)] / nrow(no_stop_words_2018) * 1000),
  dplyr::bind_cols("year" = 2019, keywords_2019[-(1)] / nrow(no_stop_words_2019) * 1000)
), digits = 2)
```
